...
class CmsPartsController < ApplicationController
  ...
  before_filter :find_part, :except => [:index, :new, :create, :show]
  before_filter :find_page_part, :only => [:show]
  before_filter :authorize_part, :only => [:show]
