...
class CmsImport
  ...
  def import_attachments(object, attachments)
    ...
    attachments.each do |attachment|
      ...
      object.attachments << new_attachment if new_attachment.present? && object.attachments.where(:filename => attachment['filename'], :filesize => new_attachment.filesize).empty? 
    end
  end
