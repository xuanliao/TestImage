  ...
  module WikiMacros
    ...
    Redmine::WikiFormatting::Macros.register do
      ...
      macro :include_page do |obj, args|
        ...
        page = CmsPage.find_by_name(args.first)
      ...
      macro :include_part do |obj, args|
        ...
        args, options = extract_macro_options(args, :parent)
        raise 'No or bad arguments.' if args.size != 1
        part = CmsPart.find_by_name(args.first)
      ...
      macro :youtube do |obj, args|
        ...
        <iframe
          width="#{width}"
          height="#{height}"
          src="#{Setting.protocol}://www.youtube.com/embed/#{args[0]}?hd=1"
          frameborder="0"
          allowfullscreen>
        </iframe>
        ~.html_safe
      ...
      macro :vimeo do |obj, args|
        ...
        %~
        <iframe
           src="#{Setting.protocol}://player.vimeo.com/video/#{args[0]}?title=0&amp;byline=0&amp;portrait=0"
           width="#{width}"
           height="#{height}"
           frameborder="0"
