module FavoriteProjectsHelper
  ...
  def favorite_project_list_style
    ...
    if params[:favorite_project_list_style].blank?
      ...
      list_style = list_styles.include?(params[:favorite_project_list_style]) ? params[:favorite_project_list_style] : RedmineFavoriteProjects.default_list_style
    end
